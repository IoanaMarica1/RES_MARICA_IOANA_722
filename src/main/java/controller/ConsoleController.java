...
public class ConsoleController {
    ...
    public ConsoleController(AstronautService astronautService, MissionEventService missionEventService, SupplyService supplyService) {
    ...
    private void registerMenu() {
        ...
        // 1
        menu.put(1, new MenuItem("Counts + print astronauts", this::option1));
        ...
        // 4
        menu.put(4, new MenuItem("Sort astronauts in file", this::option4));
    ...
    private void option1() {
        astronautService.countAstronauts();
        missionEventService.countMissionEvents();
        supplyService.countSupplys();
        astronautService.showAstronauts();
    ...
    private void option2() {
        String d = readNonEmpty("Input SpaceCraft: ");
        astronautService.filterAstronauts(d);
